...
public class SerieJUnitTest  {
    ...
    @Test
    @Order(4)
    public void getSerieByTypeTest() {
        ...
        try{
            ...
            HibernateConfigModel.setPort(3306);
            HibernateConfigModel.setInstance("localhost");
            HibernateConfigModel.setDatabase("TESTERA_5e268c990811e");
            ...
            if(Serie_.getType().compareTo("PREV")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"PREV\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("NOTC")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"NOTC\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("NOTP")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"NOTP\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("FAC")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"FAC\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("TIK")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"TIK\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("COT")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"COT\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("EMP")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"EMP\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("PROV")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"PROV\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("REM")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"REM\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("COMP")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"COMP\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("ORDC")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"ORDC\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("CXC")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"CXC\")!=0){");
                Assertions.fail();
                return;
            }
            ...
            if(Serie_.getType().compareTo("PEDIDOS")!=0){
                LoggerUtility.getSingleton().logInfo(SerieJUnitTest.class, "if(Serie_.getType().compareTo(\"PEDIDOS\")!=0){");
                Assertions.fail();
                return;
            }
