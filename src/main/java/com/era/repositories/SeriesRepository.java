...
public class SeriesRepository extends Repository {
   ...
   final public Serie getFirstSerieByType(final String type) throws Exception {
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Getting first serie NOTC");
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Returning first serie NOTC " + Serie);
    ...
    final public void addSerieTypePREV(final Serie Serie) throws Exception {
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie PREV");                
        Serie.setType("PREV");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type PREV added");
    }
    
    final public void addSerieTypeNOTC(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie NOTC");                
        Serie.setType("NOTC");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type NOTC added");
    }
    
    final public void addSerieTypeNOTP(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie NOTP");                
        Serie.setType("NOTP");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type NOTP added");
    }
    
    final public void addSerieTypeFAC(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie FAC");                
        Serie.setType("FAC");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type FAC added");
    }
    
    final public void addSerieTypeTIK(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie TIK");                
        Serie.setType("TIK");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type TIK added");
    }
    
    final public void addSerieTypeCOT(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie COT");                
        Serie.setType("COT");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type COT added");
    }
    
    final public void addSerieTypeEMP(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie EMP");                
        Serie.setType("EMP");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type EMP added");
    }
    
    final public void addSerieTypePROV(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie PROV");                
        Serie.setType("PROV");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type PROV added");
    }
    
    final public void addSerieTypeREM(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie REM");                
        Serie.setType("REM");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type REM added");
    }
    
    final public void addSerieTypeCOMP(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie COMP");                
        Serie.setType("COMP");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type COMP added");
    }
    
    final public void addSerieTypeORDC(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie ORDC");                
        Serie.setType("ORDC");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type ORDC added");
    }
    
    final public void addSerieTypeCXC(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie CXC");                
        Serie.setType("CXC");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type CXC added");
    }
    
    final public void addSerieTypePEDIDOS(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Adding serie PEDIDOS");                
        Serie.setType("PEDIDOS");
        save(Serie);        
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie type PEDIDOS added");
    }
    
    final public int updateSerie(final Serie Serie) throws Exception {
                
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: updating serie");
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie: " + Serie);
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Serie updated");                
    ...
    public Serie getBySerie(final String serie) throws Exception {
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Getting serie by serie: " + serie);
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Returning serie " + Serie);
    ...
    public Serie getSerieByType(final String type) throws Exception {
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Getting serie by type: " + type);
        ...
        LoggerUtility.getSingleton().logInfo(SeriesRepository.class, "Hibernate: Returning serie by type: " + type);
