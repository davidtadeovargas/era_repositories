...
CREATE TABLE IF NOT EXISTS `push_notifications` (
  ...
  `urlBanner` varchar(1000) NOT NULL,
  `bannerAction` 
...
SELECT * from c_aduana;

INSERT INTO c_claveprodserv
SELECT * from c_claveprodserv;

INSERT INTO c_claveunidad
SELECT * from c_claveunidad;

INSERT INTO c_codigopostal
SELECT * from c_codigopostal;
...
SELECT * from c_moneda;

INSERT INTO c_pais
SELECT * from c_pais;

INSERT INTO c_regimenfiscal
SELECT * from c_regimenfiscal;

INSERT INTO c_tipodecomprobante
SELECT * from c_tipodecomprobante;
...
BEGIN
INSERT INTO estacs(estac,pass,falt,estacglo,imptic,impfac,`52m`,cort,descu,habdesc,sucu,nocaj,nom,calle,col,cp,tel,cel,pai,esta,noint,noext,admcaj,vend,ciu,comi,ptovta,idempresa,almacen)
VALUES(
par_estac, 
par_pass, 
now(),  
...
WHERE corrselec.idempresa = '2801169316';
END//
DELIMITER ;
